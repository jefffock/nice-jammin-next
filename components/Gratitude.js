  ...
  return (
    <Box bgcolor="primary.main" minHeight="100px" my="1em">
      <Box my="auto" mx="auto" px="0.5em" width="96vw" maxWidth="fit-content" py="3em">
        ...
        <Typography sx={{ fontSize:'18px', mt: '1em', maxWidth: '1000px'}} textAlign="center">Contributors - thank you for sharing your knowledge and preferences with an attitude of love, joy, sharing, and discovery.</Typography>
      </Box>
    </Box>
  )
}