  ...
  return (
    <Box bgcolor="primary.main" minHeight="100px" my="1em">
      <Box my="auto" mx="auto" px="0.5em" width="96vw" maxWidth="fit-content" py="3em">
        ...
        <Typography sx={{ fontSize:'18px', mt: '1em', maxWidth: '1000px'}} textAlign="center">Contributors to this project - thank you for sharing your love for the music, helping it reach new ears and hearts.</Typography>
      </Box>
    </Box>
  )
}